    ...
    try {
        ...
        indivSnap.forEach(doc => {
            ...
            if (data.tipo === 'pareja' || d.nombreCompleto1) {
                const n1 = d.nombreCompleto1 || d.nombre1 || 'Paciente 1';
                const n2 = d.nombreCompleto2 || d.nombre2 || 'Paciente 2';
        ...
        parejaSnap.forEach(doc => {
            ...
            if (data.paciente1) {
                ...
                const d = data.demograficos || {};
                n1 = d.nombreCompleto1 || d.nombre1 || 'Paciente 1';
                n2 = d.nombreCompleto2 || d.nombre2 || 'Paciente 2';
            }
            patientsMap[doc.id] = `${n1.split(' ')[0]} y ${n2.split(' ')[0]}`;
        });
